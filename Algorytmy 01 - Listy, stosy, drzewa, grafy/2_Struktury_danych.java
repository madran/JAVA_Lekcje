...
//Stos mo¿na porównac do talii kart, na któr¹ od¿uca siê karty w czasie gry.
//A gdy trzeba pobraæ kartê, to bierze sie j¹ z wierzchu tej talii.
//Charakterystyczne operacje dla stosu to push, która s³u¿y umieszczania wartoœci
//na szczycie stosu i pop do jej œci¹gania.
//Stos wykorzystuje siê np.: do zapamiêtywania kolejnych wykonywanych operacji w jakimœ programi.
...
//Kolejka mo¿e byæ wykorzystywana jako bufor danych. Na przyk³ad sp³yaj¹ce zamówienia ze sklepu
//internetowego. Nastêpnie s¹ one realizowane zgodnie kolejnoœci¹ w jakiej dociera³y.
...
//Drzewo (ang. tree)
//*****************************************************************************
//Drzew to struktura, która przedstawia dane w sposób hierarchiczny. Drzewo sk³¹da siê z wêz³ów oraz ³¹cz¹cych
...
//Ka¿dy wêze³ (nie bêd¹cy korzeniem) mo¿e byæ traktowany kako pocz¹tek poddrzewa.
