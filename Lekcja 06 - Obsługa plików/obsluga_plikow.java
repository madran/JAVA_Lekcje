...
//reprezentuje plik.
File plik = new File("Sciezka/do/pliku");
//Do konstruktora można przekazac scieżkę relatwyną jak i absolutną do pliku.


//*****************************************************************************
//Ścieżka relatywna to ściezka relatywna do pliku wykonywalnego.
...
//Ścieżka absolutna to ścieżka od samego szczytu drzewa katalogów np.:
...
//do tego celu służy klasa Paths. Klasa Paths dysponuje metodą get(), do której przekezuje się scieżkę do
//pliku:
Path sieżka = Paths.get("ścieżka/do/pliku.txt");
...
//dane wprowadzanie przez użytkownika, pliki czy ciągi. Należy do pakietu java.util.
...
//*****************************************************************************
//Klasa Files dostarcza szereg statycznych metod (metody statyczhne można wywołać
...
//*****************************************************************************
//                            ||
//Byforowane ładowanie plików \/ --->używane do czytania dużych plików (np. > 1gb)
...
//Dzięki takiemu podejściu możeliwe przetwarzenie dużych plików, które są zbyt duże by załadowac je
